...
"CREATE INDEX lineitem_l_orderkey_l_suppkey_l_quantity_idx ON lineitem (l_orderkey, l_suppkey, l_quantity) WITH (fillfactor = 100) TABLESPACE fast_random_access;",
